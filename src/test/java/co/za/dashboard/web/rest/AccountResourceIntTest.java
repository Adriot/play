package co.za.dashboard.web.rest;

import co.za.dashboard.config.Constants;
import co.za.dashboard.PlayApp;
import co.za.dashboard.domain.Authority;
import co.za.dashboard.domain.User;
import co.za.dashboard.repository.AuthorityRepository;
import co.za.dashboard.repository.UserRepository;
import co.za.dashboard.security.AuthoritiesConstants;
import co.za.dashboard.service.MailService;
import co.za.dashboard.service.dto.UserDTO;
import co.za.dashboard.service.dto.PasswordChangeDTO;
import co.za.dashboard.web.rest.errors.ExceptionTranslator;
import co.za.dashboard.web.rest.vm.KeyAndPasswordVM;
import co.za.dashboard.web.rest.vm.ManagedUserVM;
import co.za.dashboard.service.UserService;
...
@SpringBootTest(classes = PlayApp.class)
